class FeedFetch {
  ...
  static String loadMoreTodos = """ 
    query loadMoreTodos (\$oldestTodoId: Int!) {
  ...
  static String newTodos = """
  query newTodos (\$latestVisibleId: Int!) {
